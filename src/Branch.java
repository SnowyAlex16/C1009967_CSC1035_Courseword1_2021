...
public class Branch extends Sale{
    ...
    public static void main(String[] args) {
       ...
       /* Branch branches = new Branch();
        ...
        branches.AverageSale("South Essex",false);
    ...
    public void ValueCompare(int comparable_amount,String branch_name){
        ...
        if (found==false){
            System.out.println(branch_name+ "has no sales higher than that amount in this branch");
        }
    ...
    public int AverageSale(String branch_name,boolean integer){
        int looping_size = sale_list.size();
